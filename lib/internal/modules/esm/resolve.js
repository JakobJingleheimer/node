...
/**
 * @typedef ResolveContext The context object containing the parent URL and conditions.
 * @prop {string[]} [ResolveContext.conditions] - The conditions for resolving the specifier.
 * @prop {string} [ResolveContext.format] - A format hint.
 * @prop {string} [ResolveContext.parentURL] - The URL of the parent module.
 */
 ...
 * @param {string} specifier - The specifier to resolve.
 * @param {ResolveContext} [context] - The context object containing the parent URL and conditions.
 */
